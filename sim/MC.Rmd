...
<details><summary>Table \@ref(tab:tab25): Simulation with correlated innovations: bias for the other parameter estimates.</summary>
```{r tab25, echo=FALSE}
library(kableExtra)
options(knitr.kable.NA = '')
