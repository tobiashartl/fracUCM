...
saveRDS(tabjoint, file = "./MC/MC_6/tab1_biasrmse_d.RDS")
...
tab3$r[tab3$r==0]<-NA
saveRDS(tab3, file = "./MC/MC_6/tab2_rmse_oth.RDS")
...
tab3$r[!c(1:36)%in%seq(1, 36, by = 3)] <- NA
tab3$r[tab3$r==0]<-NA
saveRDS(tab3, file = "./MC/MC_6/tab3_bias_oth.RDS")
...
# CSS
load(file = "./MC/MC_6/CSS/results.RData")
X.hat.CSS <- X.res
C.hat.CSS <- C.res
# ML
load(file = "./MC/MC_6/ML/results_ML.RData")
X.hat.ML <- X.res
C.hat.ML <- C.res
# CSS i1
load(file = "./MC/MC_6/CSS_INTEGER/results_i1.RData")
X.hat.i1 <- X.res
C.hat.i1 <- C.res
# CSS i1 ML
load(file = "./MC/MC_6/ML_INTEGER/results_i1_ML.RData")
X.hat.i1.ML <- X.res
C.hat.i1.ML <- C.res
# ARMA ML
load(file = "./MC/MC_6/ARMA/results_ARMA.RData")
X.hat.ARMA <- X.res
C.hat.ARMA <- C.res
...
saveRDS(tab4, file = "./MC/MC_6/tab4_rsq.RDS")
