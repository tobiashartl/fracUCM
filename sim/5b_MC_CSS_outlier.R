...
for ( i in 1:NROW(setups)){
    ...
    if(file.exists(file = paste("./MC/MC_5/CSS/Sim_R", R, "_n", n, "_d", d, "_r", r, "_outlier.RData", sep=""))) next
    set.seed(42)
    ...
    save(RESULTS, file = paste("./MC/MC_5/CSS/Sim_R", R, "_n", n, "_d", d, "_r", r, "_outlier.RData", sep=""))
}
