...
for ( i in 1:nrow(setups)){
    ...
    if(file.exists(file = paste("./MC/MC_6/ML/Sim_R", R, "_n", n, "_d", d, "_r", r, "_corr0_trend.RData", sep=""))) next
    set.seed(42)
    ...
    save(RESULTS, file = paste("./MC/MC_6/ML/Sim_R", R, "_n", n, "_d", d, "_r", r, "_corr0_trend.RData", sep=""))
}
