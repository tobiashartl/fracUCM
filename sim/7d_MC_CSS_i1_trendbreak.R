...
# get nu
nuc <- sapply(1:nrow(setups), function(x) nucalc(1, setups[x, 1], setups[x, 2], ar))
...
for ( i in 1:NROW(setups)){
    ...
    if(file.exists(file = paste("./MC/MC_7/CSS_INTEGER/Sim_R", R, "_n", n, "_d", d, "_r", r, "_trendbreak.RData", sep=""))) next
    set.seed(42)
    ...
    optfn <- function(n, y, x){
        ...
        tryCatch({
            ...
            est <- optim(par=par0, deterministics = "trend",
    ...
    save(RESULTS, file = paste("./MC/MC_7/CSS_INTEGER/Sim_R", R, "_n", n, "_d", d, "_r", r, "_trendbreak.RData", sep=""))
}
