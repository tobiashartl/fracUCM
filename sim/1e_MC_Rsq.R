...
save(X.res, C.res, results.list, X.true, C.true, 
     file = "./MC/MC_1/CSS/results.RData")
...
save(X.res, C.res, results.list, X.true, C.true, 
     file = "./MC/MC_1/ML/results_ML.RData")
...
save(X.res, C.res, results.list, X.true, C.true, 
     file = "./MC/MC_1/CSS_INTEGER/results_i1.RData")
...
save(X.res, C.res, results.list, X.true, C.true, 
     file = "./MC/MC_1/ML_Integer/results_i1_ML.RData")
    ...
    try({
        ...
        filterfun <- function(theta, y){
            KS <- fUC_KS_ARMA_approx(theta,
                                     y=y, START = 2, corr =FALSE, d.int = c(0, 2.5),
...
save(X.res, C.res, results.list, X.true, C.true, 
     file = "./MC/MC_1/ARMA/results_ARMA.RData")
