...
load(file = "./code/app2/mRVOL.RData")
...
EW(y, alpha = .7, type = 3, interval = c(0, 2))
...
# none: p=7: 5446.559 0.5392287 8.441343 -0.3564869 1.930221 -0.9686069 -1.251961 1.251969 1.321921 -1.367514 -0.6111512 0.7333234  -0.8208396 10970.75 10915.12
...
TC <- fUC_KS_ARMA_approx(theta, y - dettrend, nulim = c(0, Inf), quiet=F,
                         corr=TRUE, deterministics = det, START=1, diffuse = T, 
