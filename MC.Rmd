...
knitr::opts_knit$set(root.dir = '/Users/tobias/Documents/projects/Filtering unknown persistence/R/code')
...
tab1 <- readRDS(file = "./MC/MC_1/tab1_biasrmse_d.RDS") 
...
library(kableExtra)
options(knitr.kable.NA = '')
tab2 <- readRDS(file = "./MC/MC_1/tab2_rmse_oth.RDS") 
...
library(kableExtra)
options(knitr.kable.NA = '')
tab3 <- readRDS(file = "./MC/MC_1/tab3_bias_oth.RDS")
...
library(kableExtra)
options(knitr.kable.NA = '')
tab4 <- readRDS(file = "./MC/MC_1/tab4_rsq.RDS")
...
library(kableExtra)
options(knitr.kable.NA = '')
tab21 <- readRDS(file = "./MC/MC_2/tab1_biasrmse_d.RDS")
...
library(kableExtra)
options(knitr.kable.NA = '')
tab22 <- readRDS(file = "./MC/MC_2/tab2_rmse_oth1.RDS") %>%
...
library(kableExtra)
options(knitr.kable.NA = '')
tab23 <- readRDS(file = "./MC/MC_2/tab2_bias_oth1.RDS") %>%
    dplyr::select(c("n",  "r", "d0",  "nu0",
           "nu", "nu_i1", 
           "rho", "rho_ML", "rho_ARMA", "rho_i1", "rho_i1_ML",
           "eta_ML", "eta_ARMA", "eta_i1_ML",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab24 <- readRDS(file = "./MC/MC_2/tab2_rmse_oth2.RDS") %>%
    dplyr::select(c("n",  "r", "d0",  "nu0",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab25 <- readRDS(file = "./MC/MC_2/tab2_bias_oth2.RDS") %>%
    dplyr::select(c("n",  "r", "d0",  "nu0",
           "ar1", "ar1_ML", "ar1_ARMA", "ar1_i1","ar1_i1_ML",
           "ar2", "ar2_ML", "ar2_ARMA", "ar2_i1","ar2_i1_ML"))
# "n",  "r", "d0",  "nu0",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab4 <- readRDS(file = "./MC/MC_2/tab4_rsq.RDS")
colnames(tab4) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$R^2$~CSS~", "$R^2$~QML~", "$R^2$~ARMA~",
                     "${R^2}^{I(1)}$~CSS~", "${R^2}^{I(1)}$~QML~",
                     "$R^2$~CSS~", "$R^2$~QML~", "$R^2$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab1 <- readRDS(file = "./MC/MC_6/tab1_biasrmse_d.RDS") 
colnames(tab1) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                    "$d$~CSS~", "$d$~QML~", "$d$~ARMA~",
                    "$d^{.5}$~EW~", "$d^{.6}$~EW~", "$d^{.7}$~EW~",
                    "$d$~CSS~", "$d$~QML~", "$d$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab2 <- readRDS(file = "./MC/MC_6/tab2_rmse_oth.RDS") 
 colnames(tab2) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$\\nu$~CSS~", "$\\nu$~QML~", "$\\nu$~ARMA~",
                     "$\\nu^{I(1)}$~CSS~", "$\\nu^{I(1)}$~QML~",
                     "$b_1$~CSS~", "$b_1$~QML~", "$b_1$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab3 <- readRDS(file = "./MC/MC_6/tab3_bias_oth.RDS")
 colnames(tab3) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$\\nu$~CSS~", "$\\nu$~QML~", "$\\nu$~ARMA~",
                     "$\\nu^{I(1)}$~CSS~", "$\\nu^{I(1)}$~QML~",
                     "$b_1$~CSS~", "$b_1$~QML~", "$b_1$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab4 <- readRDS(file = "./MC/MC_6/tab4_rsq.RDS")
colnames(tab4) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$R^2$~CSS~", "$R^2$~QML~", "$R^2$~ARMA~",
                     "${R^2}^{I(1)}$~CSS~", "${R^2}^{I(1)}$~QML~",
                     "$R^2$~CSS~", "$R^2$~QML~", "$R^2$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab1 <- readRDS(file = "./MC/MC_7/tab1_biasrmse_d.RDS") 
colnames(tab1) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                    "$d$~CSS~", "$d$~QML~", "$d$~ARMA~",
                    "$d^{.5}$~EW~", "$d^{.6}$~EW~", "$d^{.7}$~EW~",
                    "$d$~CSS~", "$d$~QML~", "$d$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab2 <- readRDS(file = "./MC/MC_7/tab2_rmse_oth.RDS") 
 colnames(tab2) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$\\nu$~CSS~", "$\\nu$~QML~", "$\\nu$~ARMA~",
                     "$\\nu^{I(1)}$~CSS~", "$\\nu^{I(1)}$~QML~",
                     "$b_1$~CSS~", "$b_1$~QML~", "$b_1$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab3 <- readRDS(file = "./MC/MC_7/tab3_bias_oth.RDS")
 colnames(tab3) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$\\nu$~CSS~", "$\\nu$~QML~", "$\\nu$~ARMA~",
                     "$\\nu^{I(1)}$~CSS~", "$\\nu^{I(1)}$~QML~",
                     "$b_1$~CSS~", "$b_1$~QML~", "$b_1$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab4 <- readRDS(file = "./MC/MC_7/tab4_rsq.RDS")
colnames(tab4) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$R^2$~CSS~", "$R^2$~QML~", "$R^2$~ARMA~",
                     "${R^2}^{I(1)}$~CSS~", "${R^2}^{I(1)}$~QML~",
                     "$R^2$~CSS~", "$R^2$~QML~", "$R^2$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab1 <- readRDS(file = "./MC/MC_5/tab1_biasrmse_d.RDS") 
colnames(tab1) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                    "$d$~CSS~", "$d$~QML~", "$d$~ARMA~",
                    "$d^{.5}$~EW~", "$d^{.6}$~EW~", "$d^{.7}$~EW~",
                    "$d$~CSS~", "$d$~QML~", "$d$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab2 <- readRDS(file = "./MC/MC_5/tab2_rmse_oth.RDS") 
 colnames(tab2) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$\\nu$~CSS~", "$\\nu$~QML~", "$\\nu$~ARMA~",
                     "$\\nu^{I(1)}$~CSS~", "$\\nu^{I(1)}$~QML~",
                     "$b_1$~CSS~", "$b_1$~QML~", "$b_1$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab3 <- readRDS(file = "./MC/MC_5/tab3_bias_oth.RDS")
 colnames(tab3) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$\\nu$~CSS~", "$\\nu$~QML~", "$\\nu$~ARMA~",
                     "$\\nu^{I(1)}$~CSS~", "$\\nu^{I(1)}$~QML~",
                     "$b_1$~CSS~", "$b_1$~QML~", "$b_1$~ARMA~",
...
library(kableExtra)
options(knitr.kable.NA = '')
tab4 <- readRDS(file = "./MC/MC_5/tab4_rsq.RDS")
colnames(tab4) <- c("$n$", "$r$", "$d$~0~", "$\\nu$~0~",
                     "$R^2$~CSS~", "$R^2$~QML~", "$R^2$~ARMA~",
                     "${R^2}^{I(1)}$~CSS~", "${R^2}^{I(1)}$~QML~",
                     "$R^2$~CSS~", "$R^2$~QML~", "$R^2$~ARMA~",
